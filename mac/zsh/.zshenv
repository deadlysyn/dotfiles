...
export PATH="${HOME}/.bin:${HOME}/.local/bin:${HOME}/bin:/opt/homebrew/bin:/opt/homebrew/sbin:/bin:/usr/bin:/usr/local/bin:/sbin:/usr/sbin:/usr/local/sbin"
...
# needed by gpg for git commit signing
export GPG_TTY=$(tty)
