...
panel_volicon()
{
        ...
        if [ "$volStatus" = "yes" ]; then
            echo "$muted_icon ${volLevel}"
        elif [ "$volStatus" = "no" ]; then
            echo "$unmuted_icon ${volLevel}"
        else
            echo " ?"
        fi
}
...
panel_avolicon()
{
        ...
        if [ "$avolStatus" = "off" ]; then
            echo "$muted_icon ${avolLevel}"
        elif [ "$avolStatus" = "on" ]; then
            echo "$unmuted_icon ${avolLevel}"
        else
            echo " ?"
        fi
}
